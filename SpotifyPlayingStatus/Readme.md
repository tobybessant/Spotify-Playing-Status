...
WORKDIR /src
COPY ["SpotifyPlayingStatus.csproj", "SpotifyPlayingStatus/"]
RUN dotnet restore "SpotifyPlayingStatus/SpotifyPlayingStatus.csproj"

WORKDIR "/src/SpotifyPlayingStatus"
COPY . .
RUN dotnet build "SpotifyPlayingStatus.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "SpotifyPlayingStatus.csproj" \
...
Execute unit tests
```
cd "SpotifyPlayingStatus/test/SpotifyPlayingStatus.Tests"
dotnet test
```

Deploy function to AWS Lambda
```
cd "SpotifyPlayingStatus/src/SpotifyPlayingStatus"
